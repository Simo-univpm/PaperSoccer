...
public class MatrixSoccerField {
    ...
    private void init() {
        ...
        setRow(1,					   Directions.SOUTH, Directions.SOUTH_EAST, Directions.SOUTH_WEST); //rigaN esclusi i pali
        setRow(size.getRow()-2,	   Directions.NORTH, Directions.NORTH_EAST, Directions.NORTH_WEST); //rigaS esclusi i pali
    ...
    private void setEdge(int row, int column, Directions freeDir){
    ...
    private void setColumn(int colToSet, Directions ...freeDir){
    ...
    private void setRow(int rowToSet, Directions ...freeDir) {
